...
class Post(models.Model):
    ...
    publushed = PublishedManager() #Custom model manager
    ...
    image_caption = models.CharField(max_length=120, blank=True, null=True)
...
class Comment(models.Model):
    ...
    reply = models.ForeignKey('Comment', on_delete=models.CASCADE, related_name='replies', null=True, default=None)
